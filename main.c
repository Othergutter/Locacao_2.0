...
void forgotPass(); // Fun��o para senhas esquecidas
...
void changeUserData(struct userData * userInfo); // mudar� os dados do usu�rio

void editUser (); // editar� o usu�rio
...
void forgotPass() {
     ...
     if (userIn == 's' || userIn == 'S') {
        ...
        //poder� ser implementado um sistema real a partir desse ponto :)
     }
}
